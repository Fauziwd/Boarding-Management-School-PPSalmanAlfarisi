                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="w-full lg:w-3/4">
                            <motion.div
                                ...
                                className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300"
                            >
                                    ...
                                    <form onSubmit={submit} className="space-y-8">
                                        {Object.keys(errors).length > 0 && (
                                            <motion.div
                                                initial={{ opacity: 0, y: -20 }}
                                                animate={{ opacity: 1, y: 0 }}
                                                className="bg-red-50 dark:bg-red-900/10 border-l-4 border-red-500 dark:border-red-400 p-4 rounded-lg"
                                            >
                                                <div className="flex">
