...
const steps = [
    { id: 'pribadi', title: "Informasi Pribadi", icon: <FiUser className="w-5 h-5" /> },
    { id: 'ortu', title: "Informasi Orang Tua", icon: <FiUsers className="w-5 h-5" /> },
    { id: 'alamat', title: "Informasi Alamat", icon: <FiHome className="w-5 h-5" /> }
];
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="w-full lg:w-1/4">
                            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-lg rounded-2xl p-6 transition-all duration-300 sticky top-28">
                                <Link href={route('santris.index')} className="flex items-center text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-200 mb-6">
                                ...
                                <div className="relative">
                                    {steps.map((step, index) => (
                                        <div key={index} className="relative pb-10 last:pb-0">
                                            ...
                                            <div onClick={() => setCurrentStep(index)} className="relative flex items-start group cursor-pointer">
                                                <span className="h-10 flex items-center">
                                                    <span className={`relative flex items-center justify-center w-10 h-10 rounded-full transition-all duration-300 ring-4 ring-white dark:ring-gray-800 ${
                                                        index < currentStep ? "bg-teal-500 text-white" :
                                                        index === currentStep ? "bg-teal-600 text-white border-2 border-white dark:border-gray-900 shadow-lg" :
                                                ...
                                                <div className="ml-4 min-w-0">
                                                    <span className={`text-sm font-semibold tracking-wide uppercase ${index === currentStep ? "text-teal-600 dark:text-teal-300" : "text-gray-500 dark:text-gray-400"}`}>Step {index + 1}</span>
                            ...
                            <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:shadow-lg rounded-2xl overflow-hidden transition-all duration-300">
                                <div className="p-8 sm:p-10">
                                    <div className="mb-8">
                                        ...
                                        <p className="mt-2 text-gray-600 dark:text-gray-400">Lengkapi semua informasi pada bagian ini dengan benar.</p>
                                    </div>
                                    ...
                                    <form onSubmit={submit} className="space-y-8">
                                            ...
                                            <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 dark:border-red-400 p-4 rounded-md">
                                                <div className="flex">
                                                    ...
                                                    <div className="ml-3">
                                                        ...
                                                        <div className="mt-2 text-sm text-red-700 dark:text-red-300"><ul className="list-disc pl-5 space-y-1">{Object.keys(errors).map((key) => (<li key={key}>{errors[key]}</li>))}</ul></div>
                                                    </div>
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        <div className="flex items-center justify-between pt-8 border-t border-gray-200 dark:border-gray-700">
                                            <div>
                                                {currentStep > 0 && (
                                                    <button type="button" onClick={prevStep} className="inline-flex items-center px-6 py-3 border border-gray-300 dark:border-gray-600 shadow-sm text-base font-medium rounded-lg text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-all duration-200">Kembali</button>
                                                )}
                                            </div>
                                            <div>
                                                {currentStep < steps.length - 1 ? (
                                                    <button type="button" onClick={nextStep} className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-all duration-200">Lanjut <svg className="ml-3 -mr-1 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg></button>
                                                ) : (
