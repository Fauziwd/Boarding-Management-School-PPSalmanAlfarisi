                                ...
                                <div className="mt-6">
                                    ...
                                    >
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in">
                                            <div>
                                                ...
                                                <TextInput id="nis" value={data.nis} onChange={(e) => setData("nis", e.target.value)} />
                                            ...
                                            <div>
                                                ...
                                                <TextInput id="nama_santri" value={data.nama_santri} onChange={(e) => setData("nama_santri", e.target.value)} />
                                                <InputError message={errors.nama_santri} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="status_santri" value="Status Santri" isRequired />
                                                <select
                                                    id="status_santri"
                                                    value={data.status_santri}
                                                    onChange={(e) => setData("status_santri", e.target.value)}
                                                    disabled={data.status_santri === 'Lulus'}
                                                ...
                                                >
                                                    ...
                                                    {data.status_santri === 'Lulus' && (<option value="Lulus">Lulus</option>)}
                                                </select>
                                                <InputError message={errors.status_santri} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="tempat_lahir" value="Tempat Lahir" isRequired />
                                                <TextInput id="tempat_lahir" value={data.tempat_lahir} onChange={(e) => setData("tempat_lahir", e.target.value)} />
                                                <InputError message={errors.tempat_lahir} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="tanggal_lahir" value="Tanggal Lahir" isRequired />
                                                <TextInput type="date" id="tanggal_lahir" value={data.tanggal_lahir} onChange={(e) => setData("tanggal_lahir", e.target.value)} />
                                                <InputError message={errors.tanggal_lahir} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="jenis_kelamin" value="Jenis Kelamin" isRequired />
                                                <select id="jenis_kelamin" value={data.jenis_kelamin} onChange={(e) => setData("jenis_kelamin", e.target.value)} className="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent dark:text-white">
                                            ...
                                            <div>
                                                ...
                                                <TextInput type="number" id="anak_ke" value={data.anak_ke} onChange={(e) => setData("anak_ke", e.target.value)} />
                                                <InputError message={errors.anak_ke} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="status_yatim_piatu" value="Status Yatim/Piatu" isRequired />
                                                <select id="status_yatim_piatu" value={data.status_yatim_piatu} onChange={(e) => setData("status_yatim_piatu", e.target.value)} className="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                                    ...
                                    <div className={`${activeTab === "parents" ? "block" : "hidden"}`}>
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in">
                                            ...
                                            <div>
                                                <InputLabel htmlFor="no_hp_bapak" value="No. HP Ayah" />
                                                <TextInput type="tel" id="no_hp_bapak" value={data.no_hp_bapak} onChange={(e) => setData("no_hp_bapak", e.target.value)} />
                                                <InputError message={errors.no_hp_bapak} />
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                <InputLabel htmlFor="no_hp_ibu" value="No. HP Ibu" />
                                                <TextInput type="tel" id="no_hp_ibu" value={data.no_hp_ibu} onChange={(e) => setData("no_hp_ibu", e.target.value)} />
                                                <InputError message={errors.no_hp_ibu} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`${activeTab === "address" ? "block" : "hidden"}`}>
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-fade-in">
                                            <div className="sm:col-span-2">
                                                ...
                                                <textarea id="alamat" rows="3" className="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700" value={data.alamat} onChange={(e) => setData("alamat", e.target.value)}></textarea>
                                                <InputError message={errors.alamat} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="kelurahan" value="Kelurahan/Desa" isRequired />
                                                <TextInput id="kelurahan" value={data.kelurahan} onChange={(e) => setData("kelurahan", e.target.value)} />
                                                <InputError message={errors.kelurahan} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="kecamatan" value="Kecamatan" isRequired />
                                                <TextInput id="kecamatan" value={data.kecamatan} onChange={(e) => setData("kecamatan", e.target.value)} />
                                                <InputError message={errors.kecamatan} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="kabupaten_kota" value="Kabupaten/Kota" isRequired />
                                                <TextInput id="kabupaten_kota" value={data.kabupaten_kota} onChange={(e) => setData("kabupaten_kota", e.target.value)} />
                                                <InputError message={errors.kabupaten_kota} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="provinsi" value="Provinsi" isRequired />
                                                <TextInput id="provinsi" value={data.provinsi} onChange={(e) => setData("provinsi", e.target.value)} />
                                                <InputError message={errors.provinsi} />
                                            </div>
                                            <div>
                                                <InputLabel htmlFor="kode_pos" value="Kode Pos" isRequired />
                                                <TextInput type="number" id="kode_pos" value={data.kode_pos} onChange={(e) => setData("kode_pos", e.target.value)} />
                                            ...
                                            <div className="mt-2 flex items-center gap-8">
                                                <img
                                                    src={
                                                        ...
                                                        filePreview || `https://ui-avatars.com/api/?name=${data.nama_santri}&background=0D9488&color=fff&size=160`
                                                    }
                                                    alt="Preview"
