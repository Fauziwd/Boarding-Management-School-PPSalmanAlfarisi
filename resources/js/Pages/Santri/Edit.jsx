                                ...
                                {activeTab === "parents" && (
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            />
                                            <InputError
                                                message={errors.pekerjaan_bapak}
                                                className="mt-2"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            />
                                            <InputError
                                                message={errors.no_telpon_bapak}
                                                className="mt-2"
                                            />
                                        </div>
