                            ...
                            <table className="border-b-2 border-gray-200 min-w-full overflow-auto">
                                <thead>
                                    <tr className="border-b-2">
                                        ...
                                        <th className="px-6 py-3 text-left text-lg font-medium text-white">Kitab</th>
                                        <th className="px-6 py-3 text-left text-lg font-medium text-white">Bab</th>
                                    ...
                                    {data.length > 0 ? (
                                        data.map(({ id, santri, kitab, bab }, index) => (
                                            <tr key={id} className="border-b-2">
                                                ...
                                                <td className="px-6 py-4 text-lg text-white">{kitab}</td>
                                                <td className="px-6 py-4 text-lg text-white">{bab}</td>
